...
export type HMDBHentSortimentForDigitalSoknadQueryVariables = Exact<{ [key: string]: never }>

export type HMDBHentSortimentForDigitalSoknadQuery = {
  __typename?: 'Query'
  produkter: Array<{
    __typename?: 'Produkt'
    hmsnr?: string | null
    ...
    avtalepostId?: string | null
    avtalepostnr?: string | null
    avtaleposttittel?: string | null
    avtalepostrangering?: number | null
    isokode: string
    isotittel: string
    kategori?: string | null
    rammeavtaleId?: string | null
    tekniskeDataSomTekst: string
    kanSokesTilInstitusjon: boolean
...
export const HentSortimentForDigitalSoknadDocument = gql`
  query HentSortimentForDigitalSoknad {
    produkter(filter: { tilgjengeligForDigitalSoknad: true }) {
      hmsnr
      artikkelId
      artikkelnavn
      produktId
      ...
      kategori
      rammeavtaleId
      tekniskeDataSomTekst
      paakrevdGodkjenningskurs {
        kursId
        tittel
        isokode
      }
      kanSokesTilInstitusjon
      erIBestillingsordning
    }
  }
`

/**
 * __useHentSortimentForDigitalSoknadQuery__
 *
 * To run a query within a React component, call `useHentSortimentForDigitalSoknadQuery` and pass it any options that fit your needs.
 * When your component renders, `useHentSortimentForDigitalSoknadQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useHentSortimentForDigitalSoknadQuery({
 *   variables: {
 *   },
 * });
 */
export function useHentSortimentForDigitalSoknadQuery(
  baseOptions?: Apollo.QueryHookOptions<
    HMDBHentSortimentForDigitalSoknadQuery,
    HMDBHentSortimentForDigitalSoknadQueryVariables
  >
) {
  const options = { ...defaultOptions, ...baseOptions }
  return Apollo.useQuery<HMDBHentSortimentForDigitalSoknadQuery, HMDBHentSortimentForDigitalSoknadQueryVariables>(
    HentSortimentForDigitalSoknadDocument,
    options
  )
}
export function useHentSortimentForDigitalSoknadLazyQuery(
  ...
  const options = { ...defaultOptions, ...baseOptions }
  return Apollo.useLazyQuery<HMDBHentSortimentForDigitalSoknadQuery, HMDBHentSortimentForDigitalSoknadQueryVariables>(
    HentSortimentForDigitalSoknadDocument,
    options
  )
}
export type HentSortimentForDigitalSoknadQueryHookResult = ReturnType<typeof useHentSortimentForDigitalSoknadQuery>
export type HentSortimentForDigitalSoknadLazyQueryHookResult = ReturnType<
  typeof useHentSortimentForDigitalSoknadLazyQuery
>
export type HentSortimentForDigitalSoknadQueryResult = Apollo.QueryResult<
  HMDBHentSortimentForDigitalSoknadQuery,
  HMDBHentSortimentForDigitalSoknadQueryVariables
>
